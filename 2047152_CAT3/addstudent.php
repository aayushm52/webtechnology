...
<head>
<title>
Christ Student Imformation System
</title>
...
<span>Student ID: </span><input type="text" style="width:265px; height:30px;"  value="M-<?php 
...
<span>Course: </span><input type	="text" style="width:265px; height:30px;" name="parent" required />
<br>
<span>Address: </span><textarea style="width:265px; height:50px;" name="report" ></textarea><br>
