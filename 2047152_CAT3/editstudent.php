...
<span>Course : </span><input type	="text" style="width:265px; height:30px;" value="<?php echo $row['parent']; ?>" name="parent" required /><br>
<span>Address : </span><textarea style="width:265px; height:50px;" name="report" ><?php echo $row['report']; ?> </textarea><br><br>
